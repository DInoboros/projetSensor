...
public class StepGraphFragment extends Fragment {
    ...
    public static String TAG = "StepGraphFragment";
    private View view;
    ...
    public static StepGraphFragment newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_step_graph_fragment, container, false);
